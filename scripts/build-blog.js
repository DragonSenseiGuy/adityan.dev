...
const POSTS_DIR = '/Users/ajayn/Projects/Hack Club/dragons-website/site/content/posts';
...
function nav(prefix) {
  return `  <header class="site-nav">
    <div class="nav-inner">
      <a class="brand" href="${prefix}index.html">Aditya N</a>
      ...
      <a class="btn btn-solid nav-cta" href="mailto:hey@adityan.dev">Say hi</a>
    </div>
  </header>`;
}

const FAVICON = `<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.85em' font-size='90' font-family='Georgia,serif' font-style='italic'>A</text></svg>">`;
...
${nav(prefix)}
  ...
  <main class="container">
    <article class="article">
      <p class="eyebrow"><a href="${prefix}blog.html" class="back-link">&larr; Blog</a></p>
